...
urlpatterns = [
    ...
    path("<int:project_pk>/store", IngestEventAPIView.as_view(), name="ingest-store-no-slash"),
    path("<int:project_pk>/envelope", IngestEnvelopeAPIView.as_view(), name="ingest-envelope-no-slash"),
    ...
    path("<int:project_pk>/minidump", MinidumpAPIView.as_view(), name="ingest-minidump-no-slash"),
    ...
    path("<int:project_pk>/security", IngestSecurityAPIView.as_view(), name="ingest-security-no-slash"),
]
